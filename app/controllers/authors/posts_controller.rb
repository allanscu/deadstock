module Authors
  class PostsController < AuthorController
    ...
    # GET /posts/new
    def new
      @post = current_author.posts.most_recent.new
    end
    ...
    # POST /posts.json
    def create
      @post = current_author.posts.most_recent.new(post_params)
    ...
    private
      ...
      def set_post
        @post = current_author.posts.most_recent.friendly.find(params[:id])
      end
