class ReleasesController < ApplicationController
  ...
  private
    ...
    def release_params
      params.require(:release).permit(:number, :release_date, :name, :description, :style, :abv, :case_vol, :can_limit, :price, :additional, :canning_date, :canning_phrase, :label_inspiration, :instagram_url)
    end
end
